...
# function extract_patch_3(
#     img::AbstractArray{T, 4},
#     p_w::Integer,
#     p_h::Integer,
#     n_pts::Integer,
# )::AbstractArray{T, 4} where {T <: Real}
#     n_h, n_w, n_c, n_b = size(img)
#     n_h -= p_h + 1
#     n_w -= p_w + 1
#     pts = sample(
#         [
#             view(img, i_h:(i_h + p_h - 1), i_w:(i_w + p_w - 1), :, i_b) for i_b in 1:n_b,
#             i_w in 1:n_w, i_h in 1:n_h
#         ],
#         n_pts,
#     )
#     cat(pts...; dims = 4)
...
#     pts = [
#         view(img, i_h:(i_h + p_h - 1), i_w:(i_w + p_w - 1), :, i_b) for i_b in 1:n_b,
#         i_w in rand(1:n_w, 50), i_h in rand(1:n_h, 50)
#     ]
#     cat(pts...; dims = 4)
# end

# function extract_patch_50(
#     icnf_f::Function,
#     img::AbstractArray{T, 4},
#     p_w::Integer,
#     p_h::Integer,
